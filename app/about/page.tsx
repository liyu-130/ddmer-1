import aboutRaw from "./about-content";
...
export default async function AboutPage() {
  ...
  return (
    <FadeIn className="w-full max-w-4xl mx-auto py-6 md:py-12 px-4 sm:px-10 relative z-10">
      <div className="bg-white/40 dark:bg-slate-800/50 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/40 dark:border-white/10 transition-colors duration-700">
