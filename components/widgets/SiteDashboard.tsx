...
export default function SiteDashboard() {
  ...
  const buildDate = useConfigValue("buildDate", siteConfig.buildDate);
  const icpName = useConfigValue("icp_name", siteConfig.icpConfig?.name || "");
  const icpLink = useConfigValue("icp_link", siteConfig.icpConfig?.link || "");
  const moeIcpName = useConfigValue("moeIcp_name", siteConfig.moeIcpConfig?.name || "");
